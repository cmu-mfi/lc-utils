...
std::string img_topic = "/narrow_stereo/image_mono_rect";
std::string info_topic = "/narrow_stereo/camera_info";
std::string overlay_topic = "/narrow_stereo/overlay/image_color";
...
//    std::cout << "Camera Matrix: " << K44 << std::endl;
    ...
    try{
        ...
        listener->lookupTransform(img_msg->header.frame_id, cld_msg->header.frame_id, ros::Time(0), sTf);
    }
